...
open class FilterDurasiAdapter(val context: Context, val listDurasi: ArrayList<FilterDurasiModel>) : RecyclerView.Adapter<FilterDurasiAdapter.SingleViewHolder>(){
    ...
    override fun onBindViewHolder(holder: SingleViewHolder, position: Int) {
        holder.bind(listDurasi[position])
    }
