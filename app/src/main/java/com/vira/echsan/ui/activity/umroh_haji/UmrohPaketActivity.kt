...
import com.vira.echsan.ui.fragment.umroh.UmrohPaketFilterDialog
...
class UmrohPaketActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        posts.add(
            PaketUmrohModel(
                "Umroh Special", "Oktober 2020", "9 hari",
                "Hotel 1", "Airlines", "Lintas Darfiq", "Rp. 25.000.000"
            )
        )
        posts.add(
            PaketUmrohModel(
                "Umroh Special", "November 2020", "10 hari",
                "Hotel 2", "Airlines", "Lintas Darfiq", "Rp. 26.000.000"
            )
        )
        posts.add(
            PaketUmrohModel(
                "Umroh Special", "Desember 2020", "11 hari",
